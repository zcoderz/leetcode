 ...
 * [4,2,3,5]
 *
 * the below code walks the left and right trees to calculate boundaries. reverse the right boundary and merges
 * it to the left boundary. code has some edge cases but is fairly simple.
 *
 */
