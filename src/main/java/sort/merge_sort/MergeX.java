...
/**
 * The {@code MergeX} class provides static methods for sorting an array using an optimized version of mergesort.
 * <p>
 * In the worst case, this implementation takes &Theta;(<em>n</em> log <em>n</em>) time to sort an array of length
 * <em>n</em> (assuming comparisons take constant time).
 * <p>
...
public class MergeX {
    ...
    /**
     * Reads in a sequence of strings from standard input; mergesorts them (using an optimized version of mergesort);
     * and prints them to standard output in ascending order.
     *
     * @param args the command-line arguments
     */
    public static void main(String[] args) {
        Integer[] a = {71, 1, 5, 7, 11, 2, 21, 54, 91, 2, 4, 8, 9, 12, 111, 78};
        MergeX.sort(a);
        show(a);
    }
}