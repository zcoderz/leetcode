 ...
 * 1 ≤ rows, cols ≤ 20,000.
 *
 * This question is much more tricky than what it appears to be for a solid performant solution.
 * problem is that if there are many rows and columns the logic repeats and will become slow.
 *
...
public class SentenceScreenFitting {
    ...
    /**
     * below logic was taken from someone's discussion notes in leetcode.
     * the logic is that for each starting word in sentence you count :
     *  - the number of times the sentence would repeat in a single row
     *  - what would be the starting word in the next row
     * via the above two calculating the total times the sentence repeats becomes very easy
     * as you can iterate over the rows , tracking next word and sentence repetitions
     * @param sentence
     * @param rows
     * @param cols
     * @return
