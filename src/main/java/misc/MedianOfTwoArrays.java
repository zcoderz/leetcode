...
/**
 * https://www.geeksforgeeks.org/median-two-sorted-arrays-different-sizes-ologminn-m/ The pseudo code is to figure out
 * how many elements to pick from the first array. Once we know it, the rest is easy. i = number of elements from first
 * array j = number of elements from second array min and max variables are used to converge towards the correct i
 */
