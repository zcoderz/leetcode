...
public class ZigZagIterator {
    ...
    /**
     * need this class so that we can store the lists in an array.
     * problem is that in java you cant create an array of generic classes hence this is used as a workaround.
     */
    ...
    /**
     * if the index or the element at current list is at end, move to the next list
     * output the element in curr list and move its index ahead
     * @return
     */
    public int next() {
