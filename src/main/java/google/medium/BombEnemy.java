...
public class BombEnemy {
    ...
    /**
     * this is a very clever implementation, idea was generated from leetcode. idea is that you use dynamic programming
     * - dont recompute once computed data.
     * <p>
     * in this problem computation is horizontal and vertical , so store the cells bombed horizontally and do same for
     * those bombed vertically
     * <p>
     * and on each iteration just reuse the previously calculated info if possible. when you hit a wall, you reset the
     * row and col counts to 0 for # of cells bombed
     *
     * @param grid
     * @return
     */
