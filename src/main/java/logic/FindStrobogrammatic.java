...
public class FindStrobogrammatic {
    ...
    /**
     * recurse through the combinations to find all that would work.
     * this is again a real simple solution but coming up fresh with it is very tricky!
     * someone else at leetcode came up with below in the discussion....
     * @param buffer
     * @param left
     * @param right
     */
