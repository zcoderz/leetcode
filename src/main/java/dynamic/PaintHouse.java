 ...
 * is the cost of painting house 0 with the color red; costs[1][2] is the cost of painting house 1 with color green, and
...
public class PaintHouse {
    ...
    /**
     * this is an extremely simple solution to an otherwise seemingly complicated problem. the below is a very elegant
     * approach and isn't very intuitive, but with a lot of practice on DP problems becomes easier to invent
     * <p>
     * start from the last row and move up to the first row while calculating min cost per color choice instead of
     * recursion this works as an iterative solution as min cost can be calculated via below equation imagine two houses
     * 1 & 2
     * <p>
     * 1. cost - color1 choice = cost color 1 of house 1 + min (color choice of house 2 colors 2 & 3). 2. cost - color2
     * choice = cost color 2 of house 1 + min (color choice of house 2 colors 1 & 3). 3. cost - color3 choice = cost
     * color 3 of house 1 + min (color choice of house 2 colors 1 & 2). min cost is min (1, 2, 3) above.
     *
     * @param costs
     * @return
     */
    ...
    /**
     * calculates the cost via calling into processCosts method. and returns the min cost of the three colors in
     * question.
     *
     * @param costs
     * @return
    ...
    /**
     * this method recurses down from first to last house while calculating the min cost so far to paint the house per
     * each color choice. so as to not repeat the calculations, the costs per house/color are saved in a map for fast
    ...
    /**
     * its a good design to have a separate method that can return the key represented by the given house no and color
     * no
     *
     * @param houseNo
     * @param colorNo
