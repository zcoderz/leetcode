...
public class KnuthMorrisPratSubstringSearch {
    ...
    /**
     * the idea is that for each index you store a prior index in the array you store an index where the prefix matches
     * the suffix so that you dont have rematch the entire string again
     * <p>
     * for example for string abcaby you will build the below transitions a b c a b y 0 0 0 1 2 0
     * <p>
     * when you are comparing the above string with a string such as a b c a b c a b y 0 1 2 3 4 5 6 7 8
     * <p>
     * when you reach index 5 in above string which is a c and the value in your string is a y you go back to start
     * search from the index 2 in the prefix because chars ab before y are also present before the char c that is index
     * 2
     *
     * @param pattern
     * @return
